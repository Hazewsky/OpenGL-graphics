...
void Bullet::draw(Bengine::SpriteBatch &spriteBatch){
	...
	//вот эту херню мен€ть, так не надо делать, добавить в инит текстуру котора€ требуетс€
...
bool Bullet::update(){
	//_direction должен быть unit. 1 там, 2. “ут еще и гравитацию можно добавить, ну тип - _gravity.Ќу это в платформере
