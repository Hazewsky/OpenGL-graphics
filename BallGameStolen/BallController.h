...
//если инклудит Ball.h, то любой класс который будет инклюдить Ё“ќ“, тоже получит Ball.h
//а так быстрее дл€ компил€ции
class Grid;
...
private:
	...
	//провер€ет столк между шаром и вектором шаров, начина€ с опред. индекса
